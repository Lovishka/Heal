    ...
    <div className="fixed bottom-4 right-4 w-full max-w-sm bg-white border border-gray-200 rounded-2xl shadow-xl z-50 overflow-hidden">
      ...
      <div className="p-4 border-t">
        ...
        <div className="grid grid-cols-2 gap-2">
            <button onClick={() => handleAiAction('book_appointment')} className="flex items-center space-x-2 p-2 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 transition-colors">
                <Stethoscope size={16} />
                <span className="text-xs">Book Appointment</span>
            </button>
            <button onClick={() => handleAiAction('emergency_admission')} className="flex items-center space-x-2 p-2 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 transition-colors">
                <Hospital size={16} />
                <span className="text-xs">Emergency Admission</span>
            </button>
            <button onClick={() => handleAiAction('pay_bill')} className="flex items-center space-x-2 p-2 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 transition-colors">
                <DollarSign size={16} />
                <span className="text-xs">Pay Bill</span>
            </button>
            <button onClick={() => handleAiAction('view_dashboard')} className="flex items-center space-x-2 p-2 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 transition-colors">
                <BarChart size={16} />
    ...
    <div className="bg-gray-100 min-h-screen p-8 relative">
      <div className="max-w-7xl mx-auto pb-48">
        <header className="flex justify-between items-center mb-10">
          <h1 className="text-4xl font-extrabold text-gray-800">Patient Dashboard</h1>
        </header>
        {renderView()}
      </div>
